...
var _NativeOpusTurboModule = _interopRequireDefault(require("./NativeOpusTurboModule.js"));
...
function initializeStreamDecoder(sampleRate, channels) {
  return _NativeOpusTurboModule.default.initializeStreamDecoder(sampleRate, channels);
}
...
function resetOpusStreamDecoder() {
  return _NativeOpusTurboModule.default.resetOpusStreamDecoder();
}
