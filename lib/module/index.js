...
const OpusTurboModule = TurboModuleRegistry.getEnforcing('OpusTurbo');
 ...
 */
export async function decodeMultipleOpusPackets(opusData, packetSize) {
 ...
 */
export function initializeStreamDecoder(sampleRate, channels) {
 ...
 */
export async function decodeOpusFrame(frameData) {
 ...
 */
export async function saveDecodedDataAsWav(pcmData, filepath, sampleRate, channels) {
 ...
 */
export function resetOpusStreamDecoder() {
